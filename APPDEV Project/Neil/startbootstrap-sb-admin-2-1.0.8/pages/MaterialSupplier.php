            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="forecast.html"><i class="fa fa-bar-chart-o fa-fw"></i> Supplier price Chart</a>
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <br/>
                  ...
                  <?php 
                  echo 
                  '<b>Supplier Name: </b>'. $query[0]['supplierName'].
                  '<br/><br/><b>Supplier Address: </b>'. $query[0]['supplierAddress'].
                  '<br/><br/><b>Supplier Contact Person: </b>'. $query[0]['supplierContactPerson'].
                  '<br/><br/><b>Supplier Contact : </b>'. $query[0]['contactNum'].
                  '<br/><br/>	<b>Supplier email : </b>'.	$query[0]['emailAddress'];
                  ?>
