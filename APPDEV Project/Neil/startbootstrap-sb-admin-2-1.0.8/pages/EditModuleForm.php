...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $temp3 = "UPDATE MODULES 
                     ...
                     ."',phaseno='".$_POST['phaseno']."',personresponsible= '".$_POST['personresponsible']."',excpectedStart = '".$temp5."',expectedcompletion='".$_POST['completion']."'
           where modulesno=".$_SESSION['moduleno'];
            
            #$temp3 ="INSERT INTO MODULES VALUES (NULL,'{$_POST['description']}',null,{$_POST['phaseno']},2,'$temp5',null,'{$_POST['personresponsible']}','{$_POST['completion']}')";
            ...
            if($query4){
                 echo "Hala";
                 header("Location: http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/editmodulelist_backend.php?project=".$_SESSION['project']);
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <?php echo "Module no.". $query[0]['modulesno'];?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
        ...
        <div class="col-lg-12">
                ...
                "editmoduleform_backend.php?project=".
                 $_SESSION["project"]."&moduleno=".$_SESSION["moduleno"];?>'  style="padding-top:25px;" >
                                 <div class="form-group col-lg-12">
                                            <label>Select Phase</label>
                                            <select name="phaseno" class="form-control">
                                                <?php 

                    foreach($query2 as $row){
                        echo '<option value="'.$row['phaseno'].
                              '">'.$row["Title"].'</option>';
                    }
                                                ?>
                                ...
                                <div class="form-group col-lg-6">
                                   ...
                                   <div class="form-group col-lg-6">
                                            ...
                                            <textarea name="personresponsible"  class="form-control" rows="3"><?php echo $query[0]['personresponsible'];?></textarea>
                                </div>
                                 <div class="form-group col-lg-6">
                                            <label>Date Initialized</label>
                                            <input  name="actualstart"
             value="<?php echo substr($query[0]['excpectedStart'], 0,10);?>"
                                ...
                                <div class="form-group col-lg-6">
                                            ...
                                            type="text"
    value="<?php echo $query[0]['expectedcompletion'];?>" class=" form-control datepicker">
                                </div>
                                <div class="col-lg-12">
                                <button value="asd" name="submit" type="submit" class="btn btn-default">Submit Button</button>
                                </div>
    ...
    <script src="../codebase/sources/ext/dhtmlxscheduler_readonly.js"></script>  
