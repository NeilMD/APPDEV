    ...
    <div id="wrapper">
		...
		<div class="col-lg-12">
		 <div class="panel panel-default">
            ...
            <h3>
                <a href='<?php 
                echo "createtimetable_backend.php?project=".$_GET['project'];
                ?>'>Create Module</a>
                <br/>
                <br/>
                <a href='<?php 
                echo "EditModuleList_backend.php?project=".$_GET['project'];
                ?>'>Edit Module</a>
                 <br/>
                <br/>
                <a href='<?php 
                echo "confirmmodule_backend.php?project=".$_GET['project'];
                ?>'>Confirm Module</a>
			</h3>
