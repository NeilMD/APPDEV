    ...
    WHERE pc.projectCharterID=".$row['projectCharterID'],$conn);
                                    ...
                                    $calculated = $temp[0]['NUMBEROFEVENTS']/$temp2[0]['NUMBEROFEVENTS']*100 ;
                                        ...
                                        $calculated = '0.0';
                                            ...
                                            echo
                                    '<tr class="odd gradeX">
                                            <td><a href="projectoptions_backend.php?project='.$row['projectCharterID'].'">'.
                                    $row['projectName'].'</span></a></td>
                                            <td>'.$row['projectDescription'].' <td><div class="progress progress-striped active">
                                 <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="'. $calculated .'" aria-valuemin="0" aria-valuemax="100" style="width: '. $calculated .'%">
                                            <span class="sr-only">20% Complete</span>
                                        </div>
                                    </div></td></tr>';
