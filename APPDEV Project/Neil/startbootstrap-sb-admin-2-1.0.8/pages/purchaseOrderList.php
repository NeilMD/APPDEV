...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div >
                <div class="col-lg-12">
                    <h1 class="page-header">Material Supply List</h1>
    ...
    foreach ($list as $row) {
        ...
        <a href = "engineerPurchaseOrderView.html">'
        .$row['PurchaseOrderID'].
        '</a></td><td>'
        .$row['datesent'].
        '</td><td class="center">'
        .$supplier[$row['SupplierID']-1]['SupplierName'].
        '</td><td class="center">'
        .$statusname[$row['StatusID']-1]['statusname'].
        '</td>';
