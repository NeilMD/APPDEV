...
<body>
    ...
    <div id="page-wrapper">
    <h2>  <?php echo $query[0]['projectName'];?></h2>
	   <div class="row">
       <h1>Click module to edit</h1>    
    ...
    echo "<td class='center'><a href='editmoduleform_backend.php?project=".$_GET['project']."&moduleno=".$row['modulesno']."'>".$row['modulesno']."</a></td>";
                                        echo "<td class='center'>".$row['description']."</td>";
                                        echo "<td class='center'>".$row['excpectedStart']."</td>";
                                        echo "<td class='center'>".$row['expectedcompletion']."</td>";
