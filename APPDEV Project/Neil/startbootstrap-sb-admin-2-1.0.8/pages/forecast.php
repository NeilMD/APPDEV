...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Project Cost Forecast Chart</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
				...
				<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          Forecasted vs Actual Project Cost (March)
                        </div>
                        <!-- /.panel-heading -->
				...
				<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          Forecasted vs Actual Project Cost (February)
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
				...
				<div class="row">
				<div class="col-lg-12">
				<div class="button-size2">
                                    
										 <a href="#" class="btn btn-default"  style="margin-right: 12px">Next Page</a>
    ...
    <script>
        Morris.Bar({
          ...
          xkey: 'y',
          ykeys: ['a', 'b'],
          labels: ['Forecasted Budget', 'Actual Budget']
        });
